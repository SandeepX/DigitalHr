...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->double('salary')->nullable()->after('workspace_type');
            $table->text('uuid')->nullable()->after('salary');
            ...
            $table->string('bank_name')->nullable()->after('remarks');
            $table->bigInteger('bank_account_no')->nullable()->after('bank_name');
            $table->string('bank_account_type')->nullable()->after('bank_account_no');

            $table->bigInteger('company_id')->unsigned()->nullable()->after('bank_account_type');
