        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <table class="table table-striped table-border">
                    ...
                    <tr>
                        <td>Created:</td>
                        <td class="text-end text-success">{{\App\Helpers\AppHelper::formatDateForView($value->start_date)}} </td>
                    </tr>
                    <tr>
                        <td>Deadline:</td>
                        <td class="text-end text-danger">{{\App\Helpers\AppHelper::formatDateForView($value->end_date)}}</td>
                    </tr>
                    <tr>
                        <td>Priority:</td>
                        <td class="text-end">
