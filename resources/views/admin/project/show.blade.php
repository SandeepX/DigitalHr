                    ...
                    <div class="card-body">
                        <table class="table table-striped table-border">
                            ...
                            <tr>
                                <td>Priority:</td>
                                <td class="text-end">
                                    <span class="btn btn-secondary btn-xs"> {{ucfirst($projectDetail->priority)}}</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr class="border-0">
                                <td>Status:</td>
                                <td class="text-end">
                                    <span class="btn btn-{{$ProjectStatus[$projectDetail->status]}} btn-xs">
