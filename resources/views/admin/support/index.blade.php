                ...
                <div class="row align-items-center ">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <select class="form-select form-select-lg" name="status" id="status">
                            <option value="" {{!isset($filterParameters['status']) ? 'selected': ''}} >Select Status</option>
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        ...
                        <select class="form-select form-select-lg" name="is_seen" id="is_seen">
                            <option value="" {{!isset($filterParameters['is_seen']) ? 'selected': ''}} >Select</option>
                    ...
                    @else
                        <div class="col-lg-3 col-md-6 mb-3">
                            <label for="" class="form-label">From Date</label>
                            <input type="date"  value="{{$filterParameters['query_from']}}" name="query_from" class="form-control queryFrom">
                        </div>

                        <div class="col-lg-3 col-md-6 mb-3">
                            <label for="" class="form-label">To Date</label>
                            <input type="date"  value="{{$filterParameters['query_to']}}" name="query_to" class="form-control queryTo">
                        </div>
                    @endif
