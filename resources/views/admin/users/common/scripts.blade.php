...
<script>
    $(document).ready(function () {
        ...
        $('#branch').change(function() {
            ...
            let departmentId = "{{ isset($userDetail) ? $userDetail->department_id : '' }}";
            $('#department').empty();
            $('#posts').empty();
            if (selectedBranchId) {
                $.ajax({
        ...
        $('#post').change(function() {
            ...
            let supervisorId = "{{ isset($userDetail) ? $userDetail['supervisor_id'] : '' }}";
            let officeTimeId = "{{ isset($userDetail) ? $userDetail['office_time_id'] : '' }}";
            $('#supervisor').empty();
            $('#officeTime').empty();
    ...
    function departmentChange() {
        ...
        let postId = "{{ isset($userDetail) ? $userDetail['post_id'] : '' }}";
        $('#post').empty();
