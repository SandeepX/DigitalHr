            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <select class="form-select" id="marital_status" name="marital_status" required >
                        <option value="" {{isset($userDetail) || old('marital_status') ? '' : 'selected'}}  disabled>Choose Marital Status</option>
                        @foreach(\App\Models\User::MARITAL_STATUS as $value)
                            <option value="{{ $value }}"
    ...
    <div class="card-body pb-2">
        <div class="bank-detail">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                    <label for="number" class="form-label">Salary <span style="color: red">*</span></label>
                    <input type="number"
                           class="form-control"
                           min="0"
                           id="salary"
