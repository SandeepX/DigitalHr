...
class UserResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'bank_name' => !is_null($this->bank_name) ? removeSpecialChars($this->bank_name):'N/A',
            'bank_account_no' =>  !is_null($this->bank_account_no) ? ($this->bank_account_no):'N/A',
            'bank_account_type' => !is_null($this->bank_account_type) ? removeSpecialChars($this->bank_account_type):'N/A',
        ];
    }
}
