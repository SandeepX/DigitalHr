...
class ProjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $employees = $this->userRepo->getAllVerifiedEmployeeOfCompany($selectEmployeeColumn);
    ...
    public function create()
    {
        ...
        try {
            $select = ['name', 'id'];
            $employees = $this->userRepo->getAllVerifiedEmployeeOfCompany($select);
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            $employees = $this->userRepo->getAllVerifiedEmployeeOfCompany($selectUserColumn);
