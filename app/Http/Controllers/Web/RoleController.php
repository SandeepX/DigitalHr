...
class  RoleController extends Controller
{
    ...
    public function createPermission($roleId): Factory|View|RedirectResponse|Application
    {
        ...
        try {
            $selectPermissionGroup = ['name', 'id'];
            $selectRole = ['id', 'name', 'slug'];
            $withPermissionGroup = ['getPermission'];
            $withRole = ['permission'];
            $permissionGroupList = $this->roleRepo->getPermissionGroupDetail($selectPermissionGroup, $withPermissionGroup);
            ...
            return view($this->view . 'permission', compact('permissionGroupList',
                'role',
                'role_permission', 'isEdit'
            ));
        } catch (Exception $exception) {
            return redirect()->back()->with('danger', $exception->getMessage());
        }
