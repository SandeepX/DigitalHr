...
class UserProfileApiController extends Controller
{
    ...
    public function __construct(UserRepository $userRepo, CompanyRepository $companyRepo,AttendanceService $attendanceService)
    {
...
//                $validatedData['avatar'] = $this->decodeBase64($validatedData['avatar'],'avatar');
//            }
            $updatedData = $this->userRepo->update($userDetail, $validatedData);
            DB::commit();
